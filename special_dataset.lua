...
local special_contents_list = {
	--[[ CS:GO Weapon Case ]] 				[4001] = {
		knives = { 
			"weapon_bayonet", "weapon_knife_flip", "weapon_knife_gut", "weapon_knife_karambit", "weapon_knife_m9_bayonet", 
		},

		finishes = { 
			"vanilla", "aa_fade", "am_zebra", "aq_oiled", "hy_webs", "aq_forced", "aq_blued", "so_night", "hy_forest_boreal", "sp_tape_urban", "sp_mesh_tan", "hy_ddpat", "sp_dapple",
		},
	}, 
	...
	--[[ Winter Offensive Weapon Case ]] 	[4009] = {
		knives = { 
			"weapon_bayonet", "weapon_knife_flip", "weapon_knife_gut", "weapon_knife_karambit", "weapon_knife_m9_bayonet", 
		},
	...
	--[[ Operation Phoenix Weapon Case ]] 	[4011] = {
		knives = { 
			"weapon_bayonet", "weapon_knife_flip", "weapon_knife_gut", "weapon_knife_karambit", "weapon_knife_m9_bayonet", 
		},
	...
	--[[ Operation Breakout Weapon Case ]] 	[4018] = {
		knives = { 
	...
	--[[ Operation Vanguard Weapon Case ]] 	[4029] = {
		knives = { 
			"weapon_bayonet", "weapon_knife_flip", "weapon_knife_gut", "weapon_knife_karambit", "weapon_knife_m9_bayonet", 
		},
	...
	--[[ Chroma Case ]] 					[4061] = {
		...
		finishes = { 
            "am_marble_fade", "an_tiger_orange", "am_ruby_marbleized", "am_sapphire_marbleized", "am_blackpearl_marbleized", "am_doppler_phase1", "am_doppler_phase2", "am_doppler_phase3", "am_doppler_phase4", "aq_damascus", "aq_steel_knife", "so_purple",
		},
	}, 
	...
	--[[ Gamma Case ]] 						[4236] = {
		...
		finishes = { 
            "cu_bayonet_lore", "am_emerald_marbleized", "am_gamma_doppler_phase1", "am_gamma_doppler_phase2", "am_gamma_doppler_phase3", "am_gamma_doppler_phase4", "gs_bayonet_autotronic", "cu_bayonet_stonewash", "am_marked_up", "hy_ocean_knife",
		},
	}, 
	...
	--[[ Spectrum Case ]] 					[4351] = {
		knives = { 
            "weapon_knife_survival_bowie", "weapon_knife_butterfly", "weapon_knife_falchion", "weapon_knife_tactical", "weapon_knife_push"
		},
	...
	--[[ Horizon Case ]] 					[4482] = {
		knives = { 
            "weapon_knife_gypsy_jackknife", "weapon_knife_stiletto", "weapon_knife_widowmaker", "weapon_knife_ursus", 
		},
	...
	--[[ Shattered Web Case ]] 				[4620] = {
		knives = { 
            "weapon_knife_outdoor", "weapon_knife_cord", "weapon_knife_skeleton", "weapon_knife_canis", 
		},
