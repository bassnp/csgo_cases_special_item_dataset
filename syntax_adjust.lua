GAY = { -- VALVE WHAT ARE YOU DOING?! 3 SKINS HAVE WEAPON SPECFIC SUB NAMES!
	...
	weapon_knife_karambit = "karam",
	weapon_knife_m9_bayonet = "m9_bay",
...
sets = {
    ...
    finish_1 = function(cname, knife_set_num) 
		return {"aa_fade", "am_zebra", "aq_oiled", "hy_webs", "aq_forced", "aq_blued", "so_night", "hy_forest_boreal", "sp_tape_urban", "sp_mesh_tan", "hy_ddpat", "sp_dapple"}
	end,

    finish_1b = function(cname, knife_set_num) 
		return {"aa_fade", "am_zebra", "aq_oiled", "hy_webs", "aq_forced", "aq_blued", "sp_nightstripe", "hy_forest_boreal", "sp_tape_urban", "sp_mesh_tan", "hy_ddpat", "sp_dapple"}
	end,

    finish_2 = function(cname, knife_set_num) 
		return {
            cname == "weapon_knife_widowmaker" and "am_marble_fade_widow" or "am_marble_fade", 
            "an_tiger_orange", 
            "am_ruby_marbleized", 
            (cname == "weapon_knife_butterfly" or cname == "weapon_knife_push") and "am_sapphire_marbleized_b" or "am_sapphire_marbleized", 
            (cname == "weapon_knife_butterfly" or cname == "weapon_knife_push") and "am_blackpearl_marbleized_b" or "am_blackpearl_marbleized",
            
            cname == "weapon_knife_widowmaker" and "am_doppler_phase1_widow"  or "am_doppler_phase1", 
            cname == "weapon_knife_widowmaker" and "am_doppler_phase2_widow"  or ((cname == "weapon_knife_butterfly" or cname == "weapon_knife_push") and "am_doppler_phase2_b" or "am_doppler_phase2"), 
            cname == "weapon_knife_widowmaker" and "am_doppler_phase3_widow"  or "am_doppler_phase3", 
            cname == "weapon_knife_widowmaker" and "am_doppler_phase4_widow"  or "am_doppler_phase4", 

            (cname == "weapon_knife_gypsy_jackknife" or cname == "weapon_knife_stiletto" or cname == "weapon_knife_ursus") and "aq_damascus_prisma" 
                or ((knife_set_num == 1 and cname ~= "weapon_knife_m9_bayonet") and "aq_damascus" 
                    or (cname == "weapon_knife_widowmaker" and "aq_damascus_widow" or "aq_damascus_90" )
                ),
            
            "aq_steel_knife", 
			cname == "weapon_knife_falchion" and "so_purple_falchion"  or (cname == "weapon_knife_tactical" and "cu_purple_huntsman" or  "so_purple"),
        }
	end,
